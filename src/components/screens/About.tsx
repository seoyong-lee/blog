    ...
    <>
      ...
      <div className="flex flex-col max-w-[780px] w-full h-screen px-6 sm:px-10 lg:py-0 pt-12">
        <div className="flex flex-col sm:flex-row mt-16 place-items-center">
          <div className="avatar w-[150px] h-[150px] rounded-full mb-10 sm:mb-0">
            <img
              src="/me.png"
              width={150}
              height={150}
          ...
          <div className="flex flex-col flex-1 sm:ml-10 justify-center place-items-center sm:place-items-start">
            <h3 className="text-xl font-bold">Drew Lee</h3>
            <p className="text-sm mt-2 mb-4 font-medium leading-[1.6] text-center sm:text-left">
              프론트엔드 개발자입니다. 시각디자인을 전공하고 잠시 디자이너로
              일하다가 개발자가 되었습니다. 여기저기 관심이 많아서 새롭게
            ...
            <div className="flex gap-2 place-items-center">
              <Link
                ...
                target="_blank"
              >
                <FaLinkedin className="w-6 h-6 hover:opacity-50" />
              </Link>
              ...
              <Link to="mailto:sy3783@gmail.com">
                <MdEmail className="w-[1.6rem] h-[1.6rem] hover:opacity-50" />
              </Link>
            </div>
          </div>
        </div>
